            ...
            <div className=" flex flex-row md:text-end text-start">
                <div className="flex flex-col md:w-[35%]  md:py-10  ">
                    <div className="flex flex-row p-2">
                        <img
                            src="/vector.svg"
                            className=" flex md:hidden md:w-5 md:h-5 w-4 h-4 m-1 "
                        />
                        ...
                        <div className="hidden md:flex m-1  flex-col justify-start ">
                            <img
                                src="/vector.svg"
                                className="md:w-5 md:h-5 w-4 h-4 m-1 "
                            />
                        </div>
                    </div>
                    <div className="flex flex-row p-2">
                ...
                <div className="flex flex-col md:w-[35%] text-start md:py-10 justify-between">
                    <div className="flex flex-row  p-2">
                        <img
                            src="/vector.svg"
                            className="md:w-4 md:h-4 w-4 h-4 m-1 "
                        />
