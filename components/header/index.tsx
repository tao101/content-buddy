        ...
        <div className="relative font-sans w-full text-white flex items-center px-6 py-6  ">
            ...
            {menuOpen && (
                <motion.div
                    ...
                    className={`${
                        user
                            ? 'absolute top-0 -left-12 z-[1000] bg-primary h-[100vh] w-[20vw] flex flex-col justify-between border-r border-white'
                            : 'fixed top-0 left-0 z-[1000] bg-black h-[100vh] w-[20vw] flex flex-col justify-between border-r border-white'
                    }`}
                >
                    <div
                    ...
                    <div className="flex flex-col ">
                        {!user ? (
                            <>
                                <button className=" hover:bg-mygray flex flex-row  p-4 gap-2 items-center text-white text-md hover:underline hover:underline-offset-1 ">
                                    <AiFillHome className="w-6 h-6" /> About Us
                                </button>
                                <button
                                    onClick={onLogout}
                                    className="hover:bg-mygray flex flex-row  p-4 gap-2 items-center  text-white text-md  hover:underline hover:underline-offset-1 "
                                >
                            ...
                            <>
                                ...
                                <button
                                    ...
                                    className="hover:bg-mygray flex flex-row  p-4 gap-2 items-center text-white text-md  hover:underline hover:underline-offset-1 "
                                >
                                    <BiHelpCircle className="w-6 h-6" /> Help
                                </button>
                                <button
                                    onClick={onSignupClick}
                                    className=" hover:bg-mygray flex flex-row  p-4 gap-2 items-center text-white text-md hover:underline hover:underline-offset-1 "
